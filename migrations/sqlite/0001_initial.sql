...
CREATE TABLE IF NOT EXISTS cms_articles (
  ...
  frontmatter_json TEXT NOT NULL, source TEXT NOT NULL, content_hash TEXT NOT NULL,
...
INSERT INTO cms_schema_version(version, applied_at) VALUES (1, CURRENT_TIMESTAMP)
