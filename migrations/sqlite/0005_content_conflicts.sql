ALTER TABLE cms_drafts ADD COLUMN base_source TEXT;
CREATE TABLE cms_content_conflicts (
  id TEXT PRIMARY KEY,
...
CREATE INDEX cms_content_conflicts_open_idx ON cms_content_conflicts(status, updated_at DESC);
